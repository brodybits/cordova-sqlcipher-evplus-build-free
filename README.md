...
```shell
cordova plugin add https://github.com/litehelpers/Cordova-sqlite-evcore-extbuild-free#cordova-sqlite-evcore-common-free # --save option *recommended* for Cordova CLI pre-7.0
```
